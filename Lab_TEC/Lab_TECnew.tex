...
\subsection{实验内容和步骤}
	...
	\subsubsection{使用 Labview 程序进行控温实验}
        ...
        % \begin{figure}[htbp]
        %     \centering
        %     \includegraphics[width=0.6\textwidth]{PI_22.png} 
        ...
        % \begin{figure}[htbp]
        %     \centering
        %     \includegraphics[width=0.6\textwidth]{PID_3.png} 
        ...
        \begin{figure}[htbp]
            \centering
            \subfloat[$K_c = 300 \quad T_i=0.067min$]
            {\includegraphics[width=0.45\textwidth]{PI_22.png}\label{fig:fig-PI_22}}
            \quad
            \subfloat[$K_c = 300 \quad T_i=0.067min \quad T_d=0.025min$]
            {\includegraphics[width=0.45\textwidth]{PID_3.png}\label{fig:fig-PID_3}}
            \quad
...
\subsubsection{控温结果作图展示}
    ...
    \begin{enumerate}
        ...
        \item 控温频域图：
            ...
            由于使用正常比例坐标可能使控温效果更直观，故还使用了正常比例坐标，所作图像如\cref{fig:PID_Normal_1c}、\cref{fig:PID_Normal_2c}：
