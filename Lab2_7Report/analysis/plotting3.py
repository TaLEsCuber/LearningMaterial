...
# 绘制折线图
plt.plot(seconds[start_index:end_index], df['Untitled 2'][start_index:end_index]*1000, linewidth=4)  # 将 'Column2' 替换为实际的第二列数据名称
plt.xlabel('Time (seconds)', fontsize=20)
plt.ylabel('Voltage of Radiation Sensor(mV)', fontsize=20)
