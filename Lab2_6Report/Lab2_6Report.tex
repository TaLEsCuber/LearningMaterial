...
\subsection{实验数据分析}
	...
	\begin{figure}[htbp]
		\centering
		\subfloat[白光光源图像]
		{\includegraphics[width=0.5\textwidth]{graph3-2-1.png}\label{fig:graph3-2-1}}
		\quad
		\subfloat[绿光光源图像]
		{\includegraphics[width=0.5\textwidth]{graph3-2-2.png}\label{fig:graph3-2-2}}
		\quad
		\subfloat[红光光源图像]
		{\includegraphics[width=0.5\textwidth]{graph3-2-3.png}\label{fig:graph3-2-3}}
		\quad
